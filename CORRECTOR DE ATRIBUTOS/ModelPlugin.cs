...

{
    ...
    [Plugin("CORRECTOR_DE_ATRIBUTOS")]
    [PluginUserInterface("CORRECTOR_DE_ATRIBUTOS.MainForm")]
    public class CORRECTOR_DE_ATRIBUTOS : PluginBase
    {
        #region Fields
        ...
        */
        ...
        #region Constructor
        public CORRECTOR_DE_ATRIBUTOS(PluginData data)
        {
            Model = new Model();
            Data = data;
        }
